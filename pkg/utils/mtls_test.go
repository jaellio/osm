...
func TestSetupMutualTLS(t *testing.T) {
	...
	adsCert, err := certManager.IssueCertificate(certificate.CommonName("fake-ads"), time.Hour, certificate.ADS)
...
func TestValidateClient(t *testing.T) {
	...
	certPEM, _ := certManager.IssueCertificate(cn, 1*time.Hour, certificate.Service)
